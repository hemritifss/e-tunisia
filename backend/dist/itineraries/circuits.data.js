...
exports.CIRCUIT_BY_SLUG = exports.CIRCUIT_TEMPLATES = exports.DWELL_BY_KIND = void 0;
exports.DWELL_BY_KIND = {
    sight: 90,
    ruins: 120,
    medina: 150,
    museum: 110,
...
exports.CIRCUIT_TEMPLATES = [
    {
        ...
        summary: 'The full length of the country in one loop: the capital and its Roman suburb, the Roman interior, the holy city, the amphitheatre, then down into the Sahara before returning along the Mediterranean. This is the route to take when it is your only trip to Tunisia.',
        theme: 'heritage',
        region: 'nationwide',
        difficulty: 'moderate',
        defaultDays: 10,
    ...
    },
    {
        ...
        summary: 'Tunis, its Roman suburb and the blue village on the cliff — all of it on the TGM light rail and on foot. The densest concentration of world heritage in the country, and the easiest circuit to run without driving.',
        theme: 'city',
        region: 'north',
        difficulty: 'easy',
        defaultDays: 3,
    ...
    },
    {
        ...
        summary: 'The south on its own terms: fortified Berber granaries, troglodyte villages, a salt lake wider than some countries, and dunes you sleep in. Long drives, enormous payoff.',
        theme: 'desert',
        region: 'south',
        difficulty: 'moderate',
        defaultDays: 5,
    ...
    },
    {
        ...
        summary: 'Four cities, four centuries of building in stone, inside a 120 km triangle. The tightest heritage-per-kilometre ratio in Tunisia — and every leg is on a good road or the Sahel metro.',
        theme: 'heritage',
        region: 'centre',
        difficulty: 'easy',
        defaultDays: 4,
    ...
    },
    {
        ...
        summary: 'The Tunisia that surprises people: oak forest, wild boar country, a lake that migrating flamingos plan their year around, and a coral coast with real diving. Cool when everywhere else is not.',
        theme: 'nature',
        region: 'north',
        difficulty: 'easy',
        defaultDays: 4,
    ...
    },
    {
        ...
        summary: 'A slow island circuit with one foot on the mainland: the oldest synagogue in Africa, a village that has thrown pots for 2,000 years, street art in a Berber hamlet, and the troglodyte hills a short drive over the causeway.',
        theme: 'coast',
        region: 'south',
        difficulty: 'easy',
        defaultDays: 4,
    ...
    },
    {
        ...
        summary: 'The peninsula that supplies Tunisia with citrus, ceramics and weekend beaches. Short hops, warm water, and the country’s best-preserved Punic site at the far end.',
        theme: 'coast',
        region: 'north',
        difficulty: 'easy',
        defaultDays: 3,
    ...
    },
    {
        ...
        summary: 'Lucas shot four films in southern Tunisia and most of the sets are still out there in the sand. This runs them in one line — Mos Espa, Lars homestead, the slave quarters, the Sidi Driss hotel — with the real Berber architecture they were built from.',
        theme: 'desert',
        region: 'south',
        difficulty: 'moderate',
        defaultDays: 4,
    ...
    },
    {
        ...
        summary: 'Tunisia holds eight UNESCO World Heritage sites — more than Egypt has per square kilometre. This circuit takes all of them, in the only sequence that does not double back.',
        theme: 'heritage',
        region: 'nationwide',
        difficulty: 'moderate',
        defaultDays: 8,
    ...
    },
    {
        ...
        summary: 'Two days for people with two days. Medina in the morning, mosaics in the afternoon, the cliff village at sunset, and enough street food in between to justify the second day.',
        theme: 'city',
        region: 'north',
        difficulty: 'easy',
        defaultDays: 2,
    ...
    },
    {
        ...
        summary: 'Built entirely around what is on the plate: harissa at source, brik from a street stall, grilled fish at the port, dates picked off the palm, and one proper sit-down dinner in a merchant’s house.',
        theme: 'food',
        region: 'nationwide',
        difficulty: 'easy',
        defaultDays: 3,
    ...
    },
    {
        ...
        summary: 'A short, spectacular loop on the Algerian border where three villages cling to canyons above palm springs. Half-day drives, big scenery, and the coolest air in the south.',
        theme: 'nature',
        region: 'south',
        difficulty: 'moderate',
        defaultDays: 3,
...
exports.CIRCUIT_BY_SLUG = new Map(exports.CIRCUIT_TEMPLATES.map((c) => [c.slug, c]));
//# sourceMappingURL=circuits.data.js.map