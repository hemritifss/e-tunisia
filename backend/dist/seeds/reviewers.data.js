...
exports.reviewClosers = exports.reviewSnippets = exports.REVIEWER_DOMAIN = exports.reviewers = void 0;
exports.reviewerEmail = reviewerEmail;
...
function reviewerEmail(handle) {
    return `${handle.replace(/[^a-z0-9]/gi, '').toLowerCase()}${DOMAIN}`;
}
exports.REVIEWER_DOMAIN = DOMAIN;
exports.reviewSnippets = {
    historical: {
        pos: [
...
//# sourceMappingURL=reviewers.data.js.map