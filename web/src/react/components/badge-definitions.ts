...
export const BADGES: Record<string, BadgeDisplay> = {
    new_explorer:    { id: 'new_explorer',    label: 'New Explorer',    description: 'Welcome to Tunisia.',              emoji: '🌟', icon: 'star',       accent: '#f4c542', tint: 'var(--gold)' },
    ...
    reviewer:        { id: 'reviewer',        label: 'Reviewer',        description: 'Left your first review.',         emoji: '⭐', icon: 'star',       accent: '#ffd166', tint: 'var(--gold)' },
