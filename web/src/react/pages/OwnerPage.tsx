...
import { ListSkeleton, StatsRowSkeleton } from '../components/RouteSkeleton';
...
function Inbox_() {
  ...
  if (isLoading) return <ListSkeleton count={4} label="Loading inquiries" rowHeight={96} />;
...
function Breakdown() {
  ...
  if (isLoading) return <StatsRowSkeleton count={4} label="Loading lead sources" />;
      ...
      <div className="sheet pkg-mgr-modal" role="dialog">
        ...
        <div className="pkg-mgr-body">
          <div className="pkg-mgr-list">
            {isLoading ? <ListSkeleton count={3} label="Loading packages" rowHeight={80} />
...
function Listings({ onBoost, onPackages }: { onBoost: (p: any) => void; onPackages: (p: any) => void }) {
  ...
  if (isLoading) return <ListSkeleton count={3} label="Loading listings" rowHeight={104} />;
